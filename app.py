...
dict_agg={
  "Exportaciones Colombianas en 2021 (miles USD)":"sum",
  "Valor Importaciones 2021 (miles USD)":"sum",
  "PIB USD 2022":"mean",
  ...
  'Exportaciones promedio 2017-2021 (miles USD)':"sum",
  "Importaciones promedio 2017-2021 (miles USD)":"sum",
  "Diferencia Promedio exportaciones 2017-2021 (miles USD)":"sum",
  "Diferencia Promedio importaciones 2017-2021 (miles USD)":"sum",
  "Total Exportaciones 2017-2021 (miles USD)":"sum",
  "Suma Exportaciones Total":"mean",
  "Total Importaciones 2017-2021 (miles USD)":"sum",
...
dict_formatos={
  ...
  "Balanza Comercial en 2021":["numeric",FormatTemplate.money(0)],
  "PIB USD 2022":["numeric",FormatTemplate.money(0)],
  "Exportaciones Colombianas en 2021 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Valor Importaciones 2021 (miles USD)":["numeric",FormatTemplate.money(0)],
  ...
  'Exportaciones promedio 2017-2021 (miles USD)':["numeric",FormatTemplate.money(0)],
  "Importaciones promedio 2017-2021 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Diferencia Promedio exportaciones 2017-2021 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Diferencia Promedio importaciones 2017-2021 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Total Importaciones 2017-2021 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Total Exportaciones 2017-2021 (miles USD)":["numeric",FormatTemplate.money(0)],
...
dict_map={
    "Exportaciones promedio 2017-2021 (miles USD)":0,
    "Importaciones promedio 2017-2021 (miles USD)":0,
        ...
        dbc.CardBody([
            dcc.Checklist(
                ...
                value=['Puntaje Final',
                    ...
                    'Exportaciones promedio 2017-2021 (miles USD)',
                    'Importaciones promedio 2017-2021 (miles USD)',
    ...
    dbc.Card([
        dbc.CardHeader([
            ...
            dcc.Dropdown(
                ...
                value="Importaciones promedio 2017-2021 (miles USD)",
            )
        ],id='card-4'),
        dbc.CardBody([
            dcc.Loading(
        ...
        dbc.Card([
          ...
          dbc.CardBody([
            dcc.Checklist(
                ...
                "Exportaciones promedio 2017-2021 (miles USD)","Importaciones promedio 2017-2021 (miles USD)"],
                labelStyle={"display":"inline-block","margin-left": "auto",'padding':"5px",
...
def update_table(tab,value,check):
    ...
    filt["Ventaja Comparativa Revelada"]=(filt["Total Exportaciones 2017-2021 (miles USD)"]/filt["Suma Exportaciones Total"])/(
        filt["Total Importaciones 2017-2021 (miles USD)"]/filt["Suma Importaciones Total"])
    ...
    if "Promedio Desempleo (2017-2021)" in v:
        mean["Promedio Desempleo (2017-2021)"]=mean["Promedio Desempleo (2018-2022)"].astype(str).str[:4]
...
def calculo(paises,tab,radio,names,cadena):
    ...
    cols=[dict_tt2[tab],"Exportaciones promedio 2017-2021 (miles USD)","Importaciones promedio 2017-2021 (miles USD)",
    "Número de Empresas Exportadoras Colombianas 2022"]
