...
dtype={
    ...
    "Ranking LPI":int,
    "Población 2020 (millones)":int,
    "Promedio Desempleo (2016-2020)":float,
    "Crecimiento PIB (2016-2020)":float,
...
# Uniques Posición, Sector, Subsector
...
dict_agg={
  "Exportaciones Colombianas en 2020 (miles USD)":"sum",
  "Valor Importaciones 2020 (miles USD)":"sum",
  "PIB USD 2020":"mean",
  "Crecimiento PIB (2016-2020)":"mean",
  "Promedio Desempleo (2016-2020)":"mean",
  "Población 2020 (millones)":"mean",
  'Ranking LPI':"mean",
  "Número de Empresas Exportadoras Colombianas 2020":"sum",
  'Exportaciones promedio 2016-2020 (miles USD)':"sum",
  "Importaciones promedio 2016-2020 (miles USD)":"sum",
  "Diferencia Promedio exportaciones 2016-2020 (miles USD)":"sum",
  "Diferencia Promedio importaciones 2016-2020 (miles USD)":"sum",
  "Total Exportaciones 2016-2020 (miles USD)":"sum",
  "Suma Exportaciones Total":"mean",
  "Total Importaciones 2016-2020 (miles USD)":"sum",
...
dict_formatos={
  ...
  "Balanza Comercial en 2020":["numeric",FormatTemplate.money(0)],
  "PIB USD 2020":["numeric",FormatTemplate.money(0)],
  "Exportaciones Colombianas en 2020 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Valor Importaciones 2020 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Crecimiento PIB (2016-2020)":["numeric",FormatTemplate.percentage(1)],
  "Promedio Desempleo (2016-2020)":["numeric",FormatTemplate.percentage(1)],
  "Población 2020 (millones)":["numeric",None],
  'Ranking LPI':["numeric",None],
  "Número de Empresas Exportadoras Colombianas 2020":["numeric",None],
  'Exportaciones promedio 2016-2020 (miles USD)':["numeric",FormatTemplate.money(0)],
  "Importaciones promedio 2016-2020 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Diferencia Promedio exportaciones 2016-2020 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Diferencia Promedio importaciones 2016-2020 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Total Importaciones 2016-2020 (miles USD)":["numeric",FormatTemplate.money(0)],
  "Total Exportaciones 2016-2020 (miles USD)":["numeric",FormatTemplate.money(0)],
...
dict_formatos2={
  ...
  "Número de Empresas Exportadoras Colombianas 2020":["numeric",None],
  "Crecimiento PIB (2016-2020)":["numeric",FormatTemplate.percentage(1)],
  "Promedio Desempleo (2016-2020)":["numeric","None"],
  "Ventaja Comparativa Revelada":["numeric",None],
  'Exportaciones promedio 2016-2020 (miles USD)':["numeric",FormatTemplate.money(0)],
  "Importaciones promedio 2016-2020 (miles USD)":["numeric",FormatTemplate.money(0)],
  "PIB USD 2020":["numeric",FormatTemplate.money(0)],
...
dict_map={
    "Exportaciones promedio 2016-2020 (miles USD)":0,
    "Importaciones promedio 2016-2020 (miles USD)":0,
    "Número de Empresas Exportadoras Colombianas 2020":0
        ...
        dbc.CardBody([
            dcc.Checklist(
                ...
                value=['Puntaje Final',
                    ...
                    'Exportaciones promedio 2016-2020 (miles USD)',
                    'Importaciones promedio 2016-2020 (miles USD)',
                    'Número de Empresas Exportadoras Colombianas 2020'],
    ...
    dbc.Card([
        dbc.CardHeader([
            ...
            dcc.Dropdown(
                ...
                value="Importaciones promedio 2016-2020 (miles USD)",
            )
        ],id='card-4'),
        dbc.CardBody([
            dcc.Loading(
        ...
        dbc.Card([
          ...
          dbc.CardBody([
            dcc.Checklist(
                ...
                value=["Puntaje Final","Cuadrante de Potencialidad","Número de Empresas Exportadoras Colombianas 2020",
                "Exportaciones promedio 2016-2020 (miles USD)","Importaciones promedio 2016-2020 (miles USD)"],
                labelStyle={"display":"inline-block","margin-left": "auto",'padding':"5px",
...
def update_table(tab,value,check):
    ...
    filt["Ventaja Comparativa Revelada"]=(filt["Total Exportaciones 2016-2020 (miles USD)"]/filt["Suma Exportaciones Total"])/(
        filt["Total Importaciones 2016-2020 (miles USD)"]/filt["Suma Importaciones Total"])
    ...
    if "Promedio Desempleo (2016-2020)" in v:
        mean["Promedio Desempleo (2016-2020)"]=mean["Promedio Desempleo (2016-2020)"].astype(str).str[:4]
...
def calculo(paises,tab,radio,names,cadena):
    ...
    cols=[dict_tt2[tab],"Exportaciones promedio 2016-2020 (miles USD)","Importaciones promedio 2016-2020 (miles USD)",
    "Número de Empresas Exportadoras Colombianas 2020"]
